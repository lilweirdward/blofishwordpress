...
class WC_Square_Connect {
	...
	public function update_square_product_image( $square_item_id, $mime_type, $path_to_image ) {
		...
		$result = $this->_client->request( 'Updating Item Image', $api_path, 'POST', $request_body );
	...
	public function update_square_base_product( $s_product_id, $wc_product ) {
		...
		$category = wp_get_post_terms( $wc_product->id, 'product_cat', array( 'parent' => 0 ) );
	...
	public function create_square_variation( $square_item_id, $variation_data ) {
		...
		return $this->_client->request( 'Creating a Product Variation', $endpoint, 'POST', $variation_data );
	...
	public function update_square_variation( $square_item_id, $square_variation_id, $variation_data ) {
		...
		return $this->_client->request( 'Updating a Product Variation', $endpoint, 'PUT', $variation_data );
	...
	public function delete_square_variation( $s_product_id, $s_variation_id ) {
		...
		return $this->_client->request( 'Deleting a Product Variation', $endpoint, 'DELETE' );
	...
	public function get_square_product( $s_product_id ) {
		...
		$endpoint = 'items/' . $s_product_id;
		$response = $this->_client->request( 'Retrieving a Product', $endpoint );
	...
	public function get_square_categories() {
		...
		$response = $this->_client->request( 'Retrieving Categories', 'categories' );
	...
	public function create_square_category( $name ) {
		...
		return $this->_client->request( 'Creating Category', 'categories', 'POST', $category );
	...
	public function update_square_category( $square_category_id, $name ) {
		...
		return $this->_client->request( 'Updating Category', $endpoint, 'PUT', $category );
	...
	public function update_square_inventory( $square_variation_id, $quantity_delta, $type = 'MANUAL_ADJUST' ) {
		...
		$response  = $this->_client->request( 'Updating Inventory', $endpoint, 'POST', $inventory );
