...
function bones_fonts() {
  wp_enqueue_style('googleFonts', 'http://fonts.googleapis.com/css?family=Quicksand:300,400|Raleway:300,700');
  wp_enqueue_style('fontAwesome', 'http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css');
}

add_action('wp_enqueue_scripts', 'bones_fonts');
add_action( 'body_class', 'add_woocommerce_to_body_everywhere' );
...
//
// function my_ajax_woocommerce() {
//     $atts = array(
//         'id' => $_POST['page']
//     );
//
//     echo product_page($atts);
//
//     die();
// }
...
function product_page( $atts ) {
    // time to duplicate some WC_Shortcodes::product_page shit
}

function add_woocommerce_to_body_everywhere($classes = '') {
    $classes[] = 'woocommerce';
